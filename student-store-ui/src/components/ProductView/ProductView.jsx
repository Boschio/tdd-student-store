  ...
  const { product } = props
    return (
      <div className="product-view">
        ...
        <ProductCard product={product} productId={props.productId} shoppingCart={props.shoppingCart} 
        quantity={props.shoppingCart.quantity} handleAddItemToCart={props.handleAddItemToCart} 
